...
**Demostración:** Sean $n \in \Zp$, y sea $d = \gcd(n, n + 1)$. Entonces, $d \in \Zp$ y se cumple que:
...
Como tanto $d$ y $q - p$ son enteros positivos, y el único divisor positivo de $1$ es si mismo, entonces solo es posible que que $d = 1$. Es decir, $\gcd(n, n + 1) = 1$.
$$\qed$$
